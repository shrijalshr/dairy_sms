...
class _$CenterModelImpl implements _CenterModel {
  _$CenterModelImpl({required this.id, required this.name});
  ...
  @override
  String toString() {
    return 'CenterModel(id: $id, name: $name)';
  }
...
abstract class _CenterModel implements CenterModel {
  factory _CenterModel({required final int id, required final String name}) =
      _$CenterModelImpl;
